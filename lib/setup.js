...
function prompt(question) {
  ...
  return new Promise((resolve) => {
    // Check if stdin is piped - if so, read from /dev/tty
    const questionStream = fs.existsSync("/dev/tty") ? null : rl;
...
async function runSetup() {
  ...
  if (existingKey && existingKey.startsWith('tskey-auth-')) {
    ...
    const choice = process.env.ZOTAIL_AUTH_CHOICE || (await prompt('Choose option [1]: ')) || '1';
...
async function runInteractiveAuth(hostname) {
  ...
  if (!authURL) {
    console.log('  ✗ Could not get auth URL');
    return false;
  }
  
  console.log('\n  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('  Interactive Authentication');
  console.log('  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('');
